  ...
  return (
    <div style={styles.root}>
        ...
        <div style={styles.playerBlock}>
          ...
          <div style={styles.profileRow}>
            ...
            <div style={styles.scoreBox}>
              <SummaryLine label="B50 總分" value={data.summary.b50} />
              <SummaryLine label="新曲 B15" value={data.summary.newSongs} />
              <SummaryLine label="舊曲 B35" value={data.summary.oldSongs} />
            </div>
          </div>
          ...
          <div style={styles.generated}>生成於 {generatedAt}</div>
        </div>
        ...
        <Panel style={{ height: 154 }}>
          <div style={styles.statsRow}>
            <div style={styles.statCell}>
              <div style={styles.panelTitleSmall}>RATING 分佈</div>
            ...
            <div style={styles.statCellRight}>
              <div style={styles.panelTitleSmall}>定數分佈 (B50)</div>
              <BarChart data={constantDistribution} />
            </div>
          </div>
        </Panel>
        ...
        <Panel style={{ height: 242 }}>
          <div style={styles.bottomStats}>
            <div style={styles.radarArea}>
              <div style={styles.panelTitleSmall}>B50 譜面傾向</div>
              <RadarChart items={data.radar} />
            </div>
            <div style={styles.personalArea}>
              <div style={styles.panelTitleSmall}>個人資料</div>
      ...
      <div style={styles.rightPane}>
        ...
        <SongSection title="舊曲" subtitle="B35" charts={b35} start={16} top={b35Top} />
      </div>
